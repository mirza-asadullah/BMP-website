...
const heroVideo = "/src/assets/pages/mentalhealthsub.png";
...
export default function MentalHealthSubsection({
  onBack,
}: MentalHealthSubsectionProps) {
  return (
    <section
    ...
    lg:w-[400px] lg:h-[400px] drop-shadow-xl"
              ...
              <M.img
                src={anim9heart}
                alt="Car"
                className="absolute bottom-[-60%] left-[-90%] w-[500px] h-[200px]
    lg:w-[400px] lg:h-[400px] drop-shadow-xl"
                animate={{ y: [0, 10, 0], rotate: [0, -6, 0, 6, 0] }}
                transition={{
                  duration: 3.5,
