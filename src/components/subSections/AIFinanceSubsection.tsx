...
const heroVideo = "/src/assets/pages/aifinancesub.png";
...
export default function AIFinanceSubsection({
  onBack,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full">
          <div className="space-y-6">
            ...
            <M.div className="space-y-4 ml-1 opacity-90">
              {[
                "Asistente financiero automático",
                " Ahorros y metas personalizadas",
          ...
          <M.div className="hidden lg:flex items-center justify-center -translate-x-16 xl:-translate-x-20">
            <div className="relative w-[500px] h-[500px] xl:w-[340px] xl:h-[340px] top-10  bottom-0">
              ...
              <M.img
                src={anim7coin}
                alt="Phone"
                className="absolute bottom-[80%] left-[-40%] w-[500px] h-[200px]
    lg:w-[250px] lg:h-[250px] drop-shadow-xl z-50"
