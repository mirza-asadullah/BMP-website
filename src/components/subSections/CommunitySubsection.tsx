...
const heroVideo = "/src/assets/pages/comminitysub.png";
  ...
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full">
          <div className="space-y-6">
            ...
            <M.p className="text-sm sm:text-base lg:text-2xl  opacity-90 leading-relaxed  line-height-0.8">
              Descubre videos, música, contenido fresco
              <br />y crea tu propia comunidad
            </M.p>
            <M.div className="space-y-4 ml-1 opacity-90">
              {[
                "Feed con contenido personalizado",
                "Likes, comentarios y recompensas",
                "Espacios privados y públicos",
                "Conexión directa entre creadores y fans",
              ].map(
                (
                  item,
    ...
    lg:w-[400px] lg:h-[400px] drop-shadow-xl"
              ...
              <M.img
                src={anim6share}
                alt="Car"
                className="absolute bottom-[-70%] left-[110%] w-[500px] h-[200px]
