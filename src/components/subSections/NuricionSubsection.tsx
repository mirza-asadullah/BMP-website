...
const heroVideo = "/src/assets/pages/nutricionsub.png";
...
export default function NuricionSubsection({ onBack }: FinanceSubsectionProps) {
  return (
    <section
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full">
          <div className="space-y-6">
            ...
            <M.div className="space-y-4 ml-1 opacity-90">
              {[
                ...
                "Compra lo que falta con un clic",
          ...
          <M.div className="hidden lg:flex items-center justify-center -translate-x-16 xl:-translate-x-20">
            <div className="relative w-[500px] h-[500px] xl:w-[340px] xl:h-[340px] top-10  bottom-0">
              <img
                src={heroVideo}
                className="w-[280px] h-280px]  absolute inset-0  object-contain drop-shadow-2xl scale-300 z-40 "
              />
              <M.img
                src={anim8balance}
                alt="Phone"
                className="absolute bottom-[-20%] left-[-80%] w-[500px] h-[200px]
    lg:w-[400px] lg:h-[400px] drop-shadow-xl"
              ...
              <M.img
                src={anim8balance}
                alt="Phone"
                className="absolute bottom-[-10%] left-[80%] w-[500px] h-[200px]
    lg:w-[400px] lg:h-[400px] drop-shadow-xl"
                animate={{ y: [0, 10, 0], rotate: [0, -6, 0, 6, 0] }}
                transition={{
                  duration: 3.5,
              ...
              <M.img
                src={anim8leaf}
                alt="Car"
                className="absolute bottom-[-90%] left-[-100%] w-[500px] h-[200px]
    lg:w-[600px] lg:h-[500px] drop-shadow-xl "
              ...
              <M.img
                src={anim8apple}
                alt="Cloud"
                className="absolute bottom-[-70%] left-[70%] w-[500px] h-[200px]
