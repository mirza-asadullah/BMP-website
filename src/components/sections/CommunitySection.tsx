...
import CommunitySubsection from "../sunSections/CommunitySubsection";
const bgImage = "/src/assets/bg1.png";
const heroVideo = "/src/assets/anim/animation6.webm";
const M = motion as any;
export default function CommunitySection() {
  const [showSubsection, setShowSubsection] = useState(false);
  if (showSubsection) {
    return <CommunitySubsection onBack={() => setShowSubsection(false)} />;
  }
  return (
    <section
      ...
      <div className="relative z-10 w-[90%] max-w-[1400px] mx-auto pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full">
          <div className="space-y-6">
            ...
            >
              Crea, únete y colabora con personas que<br /> comparten tus intereses y valores.
          ...
          >
            <div className="relative w-[500px] h-[500px] xl:w-[300px] xl:h-[300px] mb-20">
              <M.img
                ...
                alt="Phone"
                className="absolute bottom-[50%] left-[120%] w-[500px] h-[200px]
    lg:w-[400px] lg:h-[400px] drop-shadow-xl"
                animate={{ y: [0, 10, 0], rotate: [0, -6, 0, 6, 0] }}
                transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
              />
              <M.img
                src="/src/assets/animicon/anim6share.png"
                alt="Car"
                className="absolute bottom-[-100%] left-[70%] w-[500px] h-[200px]
    lg:w-[280px] lg:h-[280px] drop-shadow-xl"
                animate={{ y: [0, 10, 0], rotate: [0, -6, 0, 6, 0] }}
                transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
              />
              <video
