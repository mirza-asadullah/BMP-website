...
import CommunitySubsection from "../subSections/CommunitySubsection";
const heroVideo = "/src/assets/anim/animation6.webm";
const anim6like = "/src/assets/animicon/anim6like.png";
const anim6share = "/src/assets/animicon/anim6share.png";
        ...
        <M.div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full">
          <M.div className="space-y-6" variants={contentVariants}>
            ...
            <p className="text-base sm:text-lg lg:text-3xl max-w-[40ch] opacity-90 leading-relaxed">
              Crea, únete y colabora con personas que
              <br /> comparten tus intereses y valores.
            </p>
            <div className="pt-4">
              <button
