...
import MentalHealthSubsection from "../sunSections/MentalHealthSubsection";
...
export default function MentalHealthSection() {
  ...
  if (showSubsection) {
    return <MentalHealthSubsection onBack={() => setShowSubsection(false)} />;
  }
  return (
    <section
      ...
      <div className="relative z-10 w-[90%] max-w-[1400px] mx-auto pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full">
          <div className="space-y-6">
            ...
            >
              Herramientas de bienestar emocional <br /> para ti y tu comunidad de apoyo
          ...
          >
            <div className="relative w-[500px] h-[500px] xl:w-[300px] xl:h-[300px] mb-20">
              <M.img
                src="/src/assets/animicon/anim9log.png"
                alt="Phone"
    ...
    lg:w-[400px] lg:h-[400px] drop-shadow-xl"
              ...
              />
              <M.img
                src="/src/assets/animicon/anim9heart.png"
                alt="Car"
