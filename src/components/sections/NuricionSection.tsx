...
import NuricionSubsection from "../subSections/NuricionSubsection";
const heroVideo = "/src/assets/anim/animation8.webm";
const anim8balance = "/src/assets/animicon/anim8balance.png";
const anim8leaf = "/src/assets/animicon/anim8leaf.png";
const anim8apple = "/src/assets/animicon/anim8apple.png";
        ...
        <M.div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full">
          <M.div className="space-y-6" variants={contentVariants}>
            ...
            <p className="text-base sm:text-lg lg:text-3xl max-w-[100ch] opacity-90 leading-relaxed">
              Comparte recetas, retos saludables y <br />
              planes de alimentación en tu red.
            </p>
            <div className="pt-4">
              <button
