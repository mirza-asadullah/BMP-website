...
import NuricionSubsection from "../sunSections/NuricionSubsection";
const bgImage = "/src/assets/bg1.png";
const heroVideo = "/src/assets/anim/animation8.webm";
const M = motion as any;
export default function NuricionSection() {
    const [showSubsection, setShowSubsection] = useState(false);
    if (showSubsection) {
        return <NuricionSubsection onBack={() => setShowSubsection(false)} />;
    }
    return (
        <section
            ...
            <div className="relative z-10 w-[90%] max-w-[1400px] mx-auto pt-20">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full">
                    <div className="space-y-6">
                        ...
                        >
                            Comparte recetas, retos saludables y  <br />planes de alimentación en tu red.
                    ...
                    >
                        <div className="relative w-[500px] h-[500px] xl:w-[260px] xl:h-[260px] mb-20">
                            <M.img
                                src="/src/assets/animicon/anim8balance.png"
                                alt="Phone"
                                className="absolute bottom-[-80%] left-[-110%] w-[500px] h-[200px]
    lg:w-[400px] lg:h-[400px] drop-shadow-xl"
                            ...
                            <M.img
                                src="/src/assets/animicon/anim8balance.png"
                                alt="Phone"
                                className="absolute bottom-[-30%] left-[100%] w-[500px] h-[200px]
    lg:w-[400px] lg:h-[400px] drop-shadow-xl"
                                animate={{ y: [0, 10, 0], rotate: [0, -6, 0, 6, 0] }}
                                transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
                            />
                            <M.img
                                src="/src/assets/animicon/anim8leaf.png"
                                alt="Car"
                                className="absolute bottom-[-150%] left-[-120%] w-[500px] h-[200px]
    lg:w-[600px] lg:h-[500px] drop-shadow-xl "
                                animate={{ y: [0, 10, 0], rotate: [0, -6, 0, 6, 0] }}
                                transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
                            />
                            <M.img
                                src="/src/assets/animicon/anim8apple.png"
                                alt="Cloud"
                                className="absolute bottom-[-130%] left-[100%] w-[500px] h-[200px]
    lg:w-[220px] lg:h-[250px] drop-shadow-xl z-50"
                                animate={{ y: [0, 10, 0], rotate: [0, -6, 0, 6, 0] }}
                                transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
                            />
                            <video
