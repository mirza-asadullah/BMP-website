...
const aboutUsImg = "/src/assets/pages/aboutus.png";
        ...
        <div className="relative z-10 w-[90%] max-w-[1700px] mx-auto pt-44 pl-44">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-center h-full">
            ...
            <div className="space-y-5 max-w-[950px]">
              ...
              >
                Construimos un ecosistema que conecta <br />
                personas, negocios y servicios en una sola app.
              </M.p>
              <M.div
              ...
              >
                <p>Nuestro equipo está formado por creadores, ingenieros y</p>
                <p>diseñadores que comparten una misma visión: hacer que</p>
                <p>cada mensaje, pago o interacción sea más fácil y seguro.</p>
              </M.div>
            </div>
          </div>
        </div>
