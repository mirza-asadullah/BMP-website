...
export default function WelcomePage() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #5B1A8C 0%, #841DC0 30%, #841DC0 70%, #5B1A8C 100%)",
      }}
    >
      <img
        src={bgFallback}
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(91, 26, 140, 0.7) 0%, rgba(132, 29, 192, 0.6) 30%, rgba(91, 26, 140, 0.7) 60%, rgba(132, 29, 192, 0.6) 100%)",
      ...
      <div
        ...
        style={{
          ...
          height: "100%",
          background:
            "linear-gradient(to right, rgba(30, 10, 50, 0.8) 0%, rgba(30, 10, 50, 0.4) 40%, transparent 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          height: "100%",
          background:
            "linear-gradient(to left, rgba(30, 10, 50, 0.8) 0%, rgba(30, 10, 50, 0.4) 40%, transparent 100%)",
        }}
      />
