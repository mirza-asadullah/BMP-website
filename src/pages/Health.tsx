        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="flex justify-center lg:justify-start relative">
            <div className="relative w-full max-w-md lg:max-w-lg xl:max-w-xl">
              <video 
                src="/animations/soludmental.webm" 
                autoPlay
                loop
                muted
                playsInline
              ...
              {/* Top left image */}
              <img 
                src="/images copy/social 2.png"
                alt="Mental Health Icon" 
                className="absolute top-0 left-6 w-28 h-28 sm:w-20 sm:h-20 md:w-40 md:h-40 lg:w-40 lg:h-40 z-10"
              />
              
              {/* Bottom right image */}
              <img 
                src="/images copy/mentalsocial.png"
                alt="Mental Health Social" 
                className="absolute bottom-0 right-10 w-28 h-28 sm:w-20 sm:h-20 md:w-40 md:h-40 lg:w-40 lg:h-40 z-10"
              />
            </div>
          </div>
          ...
          <div className="text-center lg:text-left space-y-1">
            ...
            <p className="text-lg lg:text-xl text-gray-300 leading-relaxed">
              Find breathing exercises, reminders to disconnect and wellness content day by day.
            </p>
          </div>
        </div>
      </section>
