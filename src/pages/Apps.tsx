        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="flex justify-center lg:justify-start relative z-30">
            ...
            <img 
              src="/apps.png"
              alt="Apps Icons" 
              className="absolute top-15 sm:top-70 md:left-20 left-2 w-960 h-96 lg:w-96 lg:h-96 z-[-1]"
            />
            
            <img 
              src="/images copy/apps 2.png"
              alt="Apps Icons" 
              className=" absolute md:right-auto right-45 w-40 h-40 lg:w-60 lg:h-60 z-[-1] rotate-[-55deg]"
            />
          </div>
