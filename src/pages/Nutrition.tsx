        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="flex justify-center lg:justify-start relative">
            <div className="relative w-full max-w-md lg:max-w-lg xl:max-w-xl">
              ...
              {/* Left leaf image */}
              <img 
                src="/images copy/leaf_Image.png"
                alt="Leaf" 
                className="absolute top-90 md:top-130 transform -translate-y-1/2 w-40 h-40 sm:w-60 sm:h-60 z-10"
              />
              
              {/* Right apple image */}
              <img 
                src="/images copy/apple_image.png"
                alt="Apple" 
                className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6  w-30 h-30 sm:w-60 sm:h-60 z-50"
              />
              
              {/* Top right nutrition trazo */}
              <img 
                src="/images copy/nutriction_trazo.png"
                alt="Nutrition" 
                className="absolute top-20 right-1  w-30 h-30 sm:w-45 sm:h-45  z-10"
              />
               <img 
                src="/images copy/nutriction_trazo.png"
                alt="Nutrition" 
                className="absolute top-40 left-[-1px]  w-30 h-30 sm:w-45 sm:h-45  z-10"
              />
            </div>
          </div>
          ...
          <div className="text-center lg:text-left space-y-1">
            ...
            <p className="text-lg lg:text-xl text-gray-300 leading-relaxed">
              Smart nutrition designed for you. Technology that takes care of what you eat.
            </p>
          </div>
        </div>
      </section>
