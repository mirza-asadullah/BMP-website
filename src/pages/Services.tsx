...
const serviceCard = "/src/assets/pages/servicecard.png";
              ...
              >
                <p>
                  ...
                  <span className="opacity-80">
                    {" "}
                    → Chats, llamadas y grupos privados.
                  </span>
                </p>
                <p>
                ...
                <p>
                  ...
                  <span className="opacity-80">
                    {" "}
                    → Compra lo que quieras, local o global.
                  </span>
                </p>
                <p>
                  ...
                  <span className="opacity-80">
                    {" "}
                    → Transporte, comida, reservas y más.
                  </span>
                </p>
                <p>
                  ...
                  <span className="opacity-80">
                    {" "}
                    → Videos, música, contenidos y grupos sociales.
                  </span>
                </p>
                <p>
                  ...
                  <span className="opacity-80">
                    {" "}
                    → Salud mental, nutrición y Finanzas con IA.
                  </span>
                </p>
              </M.div>
            </div>
